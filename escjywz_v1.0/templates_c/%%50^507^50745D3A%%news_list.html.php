<?php /* Smarty version 2.6.18, created on 2015-10-21 19:30:23
...
?m=news&a=add" class="add">添加新闻</a></li>
			</ul>	
		</div>
		<div class="searchR">
...
" method="get" name="form2">
 ...
 <input type="text" name="keywords" id="searchkey" value="" class="inp01"> &nbsp;<input type="submit" name="filtersubmit" value="查询" class="combutton02"><input type="hidden" name="m" value="news">
...
"></td>
		...
		<td><a href="<?php echo $this->_tpl_vars['htmldir']; ?>
news/<?php echo $this->_tpl_vars['news']['n_date']; ?>
/<?php echo $this->_tpl_vars['news']['n_id']; ?>
.html" target="_blank"/><?php echo $this->_tpl_vars['news']['n_title']; ?>
...
?m=news&a=html&id=<?php echo $this->_tpl_vars['news']['n_id']; ?>
&page=<?php echo $this->_tpl_vars['page']; ?>
" class="html">生成静态</a> | <a href="<?php echo $this->_tpl_vars['adminpage']; ?>
?m=news&a=edit&id=<?php echo $this->_tpl_vars['news']['n_id']; ?>
&page=<?php echo $this->_tpl_vars['page']; ?>
" class='edit'>编辑</a> | <a href="javascript:if(confirm('确实要删除吗?'))location='<?php echo $this->_tpl_vars['adminpage']; ?>
?m=news&a=del&id=<?php echo $this->_tpl_vars['news']['n_id']; ?>
&page=<?php echo $this->_tpl_vars['page']; ?>
'" class="del">删除</a>
	</td>
	</tr>
...
?m=news&a=bulkdel&page=<?php echo $this->_tpl_vars['page']; ?>
','删除');" title="请选择后操作">删除</a> <a href="javascript:submitForm('<?php echo $this->_tpl_vars['adminpage']; ?>
?m=news&a=bulkhtml&page=<?php echo $this->_tpl_vars['page']; ?>
